$(function(){
    ...
    function lunbo(obj){
        ...
        var n1=0
        var next=0
        var t1=setInterval(move3,10000)
        function move3(type){
            if(type=="l"){
                n1--
                if(n1<0){
    ...
    var box2=$(".floor-one-bsnav",obj)[0]
        ...
        var t3=setInterval(move4,10000)//传入两个参数
        function move4(){
            if(!flag){
                return
            }
            ...
            animate(imgs2,{left:-170},10000,function(){//
        ...
        function move5(){
            ...
            animate(imgs2,{left:0},10000,function(){
            flag=true
            })
        }
